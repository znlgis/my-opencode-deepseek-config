...
| Skill | 作用 |
| --- | --- |
| `gh-cli` | 用官方 `gh` CLI 操作 GitHub，基于 [cli/cli](https://github.com/cli/cli) v2.96+ 全面覆盖：PR/Issue/Actions/Release/Discussion/Search/Project/Gist/Secret/Variable/Codespace/Config/Extension/Alias/Ruleset/API 等 30+ 命令组 |
...
| `code-review` | Token 高效的多维度代码审查：diff 体量分级、7 维度+严重度清单、项目上下文校准、对抗性自检、文档漂移批处理、审查→修复循环 |
...
│   ├── gh-cli/SKILL.md        ← GitHub CLI 全面操作（v2.96+，30+ 命令组）
│   ├── gh-skill/SKILL.md
