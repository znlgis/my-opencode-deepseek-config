...
| Skill | 作用 |
| --- | --- |
| `gh-cli` | 用官方 `gh` CLI 操作 GitHub，基于 [cli/cli](https://github.com/cli/cli) v2.9x+ 全面覆盖：PR/Issue/Actions/Release/Discussion/Search/Project/Gist/Secret/Variable/Codespace/Config/Extension/Alias/Ruleset/API + `agent-task`/`copilot` AI 命令，含 Issue 层级 GHES 版本要求 |
...
│   ├── gh-cli/SKILL.md        ← GitHub CLI 全面操作（v2.9x+，含 agent-task/copilot）
│   ├── gh-skill/SKILL.md
